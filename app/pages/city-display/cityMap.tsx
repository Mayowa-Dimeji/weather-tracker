...
const CityMap = ({ lat = 51.5074, lng = -0.1276, zoom = 8 }) => {
  ...
  return (
    <section className="border border-gray-300 flex flex-col p-4 rounded-lg w-full md:w-2/3 object-contain">
      ...
      <section
        ref={mapContainer}
        className="map-container w-full h-64 md:h-96 rounded-md shadow-md"
      ></section>
    </section>
  );
};
